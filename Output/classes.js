...
var Usuario = /*#__PURE__*/function () {
  function Usuario(nombres, apellidos, edad) {
  ...
  _createClass(Usuario, [{
    ...
    value: function mostrarInfo() {
      return "\n            <b>Nombre : </b> ".concat(this.nombres, " <br/>\n            <b>Apellido : </b> ").concat(this.apellidos, " <br/>\n            <b>Edad : </b> ").concat(this.edad, " <br/>\n            <hr/>\n        ");
    }
  }]);
...
var Estudiante = /*#__PURE__*/function (_Usuario) {
  ...
  function Estudiante(nombres, apellidos, edad, carrera) {
    var _this;

    _classCallCheck(this, Estudiante);

    _this = _super.call(this, nombres, apellidos, edad);
...
var horacio = new Usuario("Horacio", "Escovilla", 50);
document.write(horacio.mostrarInfo());
var segismundo = new Estudiante("Segismundo", "Perez", 45, "Desarrolador web");
